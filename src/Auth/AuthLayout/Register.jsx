...
const Register = () => {
  ...
  return (
    <div className="card bg-base-100 w-11/12 mx-auto my-12">
      <h1 className="font-bold text-3xl lg:text-5xl my-3 text-center text-accent">Register Now!</h1>
      <div className="flex flex-col-reverse lg:flex-row justify-around items-center">
        ...
        <div>
          <img src={signUP} className="max-w-[400px]" alt="" />
        </div>
      </div>
    </div>
  );
