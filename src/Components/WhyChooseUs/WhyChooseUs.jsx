...
const WhyChooseUs = () => {
  return (
    <section className=" my-10">
     <h1 className="lg:text-5xl text-3xl font-bold text-accent text-center my-12">Why You Should Trust Us</h1>
          ...
          <div className="grid grid-cols-2 gap-6 mt-8">
            <div>
              ...
              <p className="text-sm text-gray-600">
                Your safety is our top priority, with expert <br /> guides and secure accommodations.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Stay connected throughout your journey <br /> with complimentary Wi-Fi access.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                We power our camps and lodges with solar <br /> energy to protect the environment.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Explore off-road trails and scenic routes with <br /> our guided mountain biking tours.
              </p>
            </div>
          </div>
        </div>
